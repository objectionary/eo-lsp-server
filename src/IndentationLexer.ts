...
export class IndentationLexer extends Lexer {
    ...
    private getIndentLevel(text: string): number {
        const afterNewline = text.substring(text.indexOf('\n') + 1);
    ...
    public nextToken(): Token {
        ...
        if (this.isEOL(token) && token.type !== Token.EOF) {
            const currentIndent = this.getIndentLevel(token.text || "");
    ...
    get channelNames(): string[] { return this.wrapped.channelNames; }
    get grammarFileName(): string { return this.wrapped.grammarFileName; }
    get modeNames(): string[] { return this.wrapped.modeNames; }
    get ruleNames(): string[] { return this.wrapped.ruleNames; }
    get serializedATN(): string { return this.wrapped.serializedATN; }
    get vocabulary(): any { return this.wrapped.vocabulary; }
}